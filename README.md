...
W is calculated using the same equation we use to solve linear regression using a closed solution
(normal equation).
Step 4:
...
## OUTPUT :
![EXPERIMENT-5-IMPLEMENTATION-OF-XOR-USING-RBF](ex5(1).png)
![EXPERIMENT-5-IMPLEMENTATION-OF-XOR-USING-RBF](ex5(2).png)
